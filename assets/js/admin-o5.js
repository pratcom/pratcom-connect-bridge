 ...
 * (pratcomEmbed.origins, dérivée des hôtes du service) OU dont
...
(function () {
     ...
     * wp_localize_script (pratcomEmbed.origins). Filet de sécurité : si l'objet
     * localisé est absent, on retombe sur les hôtes publics connus du service.
     */
    var ALLOWED = (typeof window.pratcomEmbed !== 'undefined' && Array.isArray(window.pratcomEmbed.origins))
        ? window.pratcomEmbed.origins
